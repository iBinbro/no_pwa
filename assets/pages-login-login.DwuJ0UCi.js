import{r as e,g as t,c as n,w as r,i,o as a,a as o,d as s,e as c,s as l,f as u}from"./index-nlPB8VKa.js";import{_ as d}from"./plugin-vueexport-helper.BCo6x5W8.js";var p={};
/**
 * @license
 ...
 * limitations under the License.
 */
class ae{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map((e=>{if(function(e){const t=e.getComponent();return"VERSION"===(null==t?void 0:t.type)}(e)){const t=e.getImmediate();return`${t.library}/${t.version}`}return null})).filter((e=>e)).join(" ")}}const oe="@firebase/app",se="0.10.10",ce=new class{constructor(e){this.name=e,this._logLevel=$,this._logHandler=H,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in j))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel="string"==typeof e?L[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if("function"!=typeof e)throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,j.DEBUG,...e),this._logHandler(this,j.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,j.VERBOSE,...e),this._logHandler(this,j.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,j.INFO,...e),this._logHandler(this,j.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,j.WARN,...e),this._logHandler(this,j.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,j.ERROR,...e),this._logHandler(this,j.ERROR,...e)}}("@firebase/app"),le="@firebase/app-compat",ue="@firebase/analytics-compat",de="@firebase/analytics",pe="@firebase/app-check-compat",he="@firebase/app-check",fe="@firebase/auth",ge="@firebase/auth-compat",me="@firebase/database",be="@firebase/database-compat",we="@firebase/functions",ye="@firebase/functions-compat",ve="@firebase/installations",Ie="@firebase/installations-compat",Se="@firebase/messaging",_e="@firebase/messaging-compat",Ee="@firebase/performance",Ce="@firebase/performance-compat",ke="@firebase/remote-config",De="@firebase/remote-config-compat",Ae="@firebase/storage",Te="@firebase/storage-compat",Oe="@firebase/firestore",Pe="@firebase/vertexai-preview",Be="@firebase/firestore-compat",Ne="firebase",je="[DEFAULT]",Me={[oe]:"fire-core",[le]:"fire-core-compat",[de]:"fire-analytics",[ue]:"fire-analytics-compat",[he]:"fire-app-check",[pe]:"fire-app-check-compat",[fe]:"fire-auth",[ge]:"fire-auth-compat",[me]:"fire-rtdb",[be]:"fire-rtdb-compat",[we]:"fire-fn",[ye]:"fire-fn-compat",[ve]:"fire-iid",[Ie]:"fire-iid-compat",[Se]:"fire-fcm",[_e]:"fire-fcm-compat",[Ee]:"fire-perf",[Ce]:"fire-perf-compat",[ke]:"fire-rc",[De]:"fire-rc-compat",[Ae]:"fire-gcs",[Te]:"fire-gcs-compat",[Oe]:"fire-fst",[Be]:"fire-fst-compat",[Pe]:"fire-vertex","fire-js":"fire-js",[Ne]:"fire-js-all"},Le=new Map,$e=new Map,Re=new Map;function He(e,t){try{e.container.addComponent(t)}catch(n){ce.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,n)}}function Fe(e){const t=e.name;if(Re.has(t))return ce.debug(`There were multiple attempts to register component ${t}.`),!1;Re.set(t,e);for(const n of Le.values())He(n,e);for(const n of $e.values())He(n,e);return!0}function xe(e,t){const n=e.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),e.container.getProvider(t)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ke{constructor(e,t,n){this._isDeleted=!1,this._options=Object.assign({},e),this._config=Object.assign({},t),this._name=t.name,this._automaticDataCollectionEnabled=t.automaticDataCollectionEnabled,this._container=n,this.container.addComponent(new O("app",(()=>this),"PUBLIC"))}get automaticDataCollectionEnabled(){return this.checkDestroyed(),this._automaticDataCollectionEnabled}set automaticDataCollectionEnabled(e){this.checkDestroyed(),this._automaticDataCollectionEnabled=e}get name(){return this.checkDestroyed(),this._name}get options(){return this.checkDestroyed(),this._options}get config(){return this.checkDestroyed(),this._config}get container(){return this._container}get isDeleted(){return this._isDeleted}set isDeleted(e){this._isDeleted=e}checkDestroyed(){if(this.isDeleted)throw Ve.create("app-deleted",{appName:this._name})}}function We(e,t={}){let n=e;if("object"!=typeof t){t={name:t}}const r=Object.assign({name:je,automaticDataCollectionEnabled:!1},t),i=r.name;if("string"!=typeof i||!i)throw Ve.create("bad-app-name",{appName:String(i)});if(n||(n=v()),!n)throw Ve.create("no-options");const a=Le.get(i);if(a){if(D(n,a.options)&&D(r,a.config))return a;throw Ve.create("duplicate-app",{appName:i})}const o=new N(i);for(const c of Re.values())o.addComponent(c);const s=new Ke(n,r,o);return Le.set(i,s),s}function ze(e,t,n){var r;let i=null!==(r=Me[e])&&void 0!==r?r:e;n&&(i+=`-${n}`);const a=i.match(/\s|\//),o=t.match(/\s|\//);if(a||o){const e=[`Unable to register library "${i}" with version "${t}":`];return a&&e.push(`library name "${i}" contains illegal characters (whitespace or "/")`),a&&o&&e.push("and"),o&&e.push(`version name "${t}" contains illegal characters (whitespace or "/")`),void ce.warn(e.join(" "))}Fe(new O(`${i}-version`,(()=>({library:i,version:t})),"VERSION"))}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
const At="firebase-installations-database",Tt=1,Ot="firebase-installations-store";let Pt=null;function Bt(){return Pt||(Pt=Z(At,Tt,{upgrade:(e,t)=>{if(0===t)e.createObjectStore(Ot)}})),Pt}async function Nt(e,t){const n=_t(e),r=(await Bt()).transaction(Ot,"readwrite"),i=r.objectStore(Ot),a=await i.get(n);return await i.put(t,n),await r.done,a&&a.fid===t.fid||Ct(e,t.fid),t}async function jt(e){const t=_t(e),n=(await Bt()).transaction(Ot,"readwrite");await n.objectStore(Ot).delete(t),await n.done}async function Mt(e,t){const n=_t(e),r=(await Bt()).transaction(Ot,"readwrite"),i=r.objectStore(Ot),a=await i.get(n),o=t(a);return void 0===o?await i.delete(n):await i.put(o,n),await r.done,!o||a&&a.fid===o.fid||Ct(e,o.fid),o}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */}async function Ft({appConfig:e,heartbeatServiceProvider:t},n){const r=function(e,{fid:t}){return`${ht(e)}/${t}/authTokens:generate`}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(t);(await e.firebaseDependencies.analyticsProvider.get()).logEvent(r,{message_id:n[Xt],message_name:n[Zt],message_time:n[en],message_device_time:Math.floor(Date.now()/1e3)})}async function Bn(e,t){const n=t.data;if(!n.isFirebaseMessaging)return;e.onMessageHandler&&n.messageType===rn.PUSH_RECEIVED&&("function"==typeof e.onMessageHandler?e.onMessageHandler(Cn(n)):e.onMessageHandler.next(Cn(n)));const r=n.data;var i;"object"==typeof(i=r)&&i&&Xt in i&&"1"===r["google.c.a.e"]&&await Pn(e,n.messageType,r)}const Nn="@firebase/messaging",jn="0.12.10",Mn=e=>{const t=e.getProvider("messaging").getImmediate();return{getToken:e=>On(t,e)}};
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $n(e=function(e=je){const t=Le.get(e);if(!t&&e===je&&v())return We();if(!t)throw Ve.create("no-app",{appName:e});return t}()){return Ln().then((e=>{if(!e)throw wn.create("unsupported-browser")}),(e=>{throw wn.create("indexed-db-unsupported")})),xe(T(e),"messaging").getImmediate()}Fe(new O("messaging",(e=>{const t=new An(e.getProvider("app").getImmediate(),e.getProvider("installations-internal").getImmediate(),e.getProvider("analytics-internal"));return navigator.serviceWorker.addEventListener("message",(e=>Bn(t,e))),t}),"PUBLIC")),Fe(new O("messaging-internal",Mn,"PRIVATE")),ze(Nn,jn),ze(Nn,jn,"esm2017");const Rn=d({__name:"login",setup(d){const p=e(!1);switch(t().platform){case"android":console.log("运行Android上");break;case"ios":console.log("运行iOS上");break;default:console.log("运行在开发者工具上")}function h(e){l({url:"/pages/tab_bar/home/home"})}return async function(e,t){return On(e=T(e),t)}($n(We({apiKey:"AIzaSyAs08yRwVbpj9ORq6oOaLQOjlic4DRsPwc",authDomain:"pwatest-bf115.firebaseapp.com",projectId:"pwatest-bf115",storageBucket:"pwatest-bf115.appspot.com",messagingSenderId:"362906119502",appId:"1:362906119502:web:687ac6667ef4f9e003421f"})),{vapidKey:" BFNQtiGsPiCJ7bJ8UJeO027lE7WPzDgu_gdj8MlXzzbGEkRNfoBsDrPAPPAmDGh1SAnvpo5VEPowy_-1OSoFtCg"}).then((e=>{e?console.log(`currentToken=${e}`):console.log("No registration token available. Request permission to generate one.")})).catch((e=>{console.log("An error occurred while retrieving token. ",e)})),console.log("initFirebaseConfig"),(e,t)=>{const l=i,d=u;return a(),n(l,{class:"loginBack theme-gradient"},{default:r((()=>[o(l,{class:"loginBtnArea"},{default:r((()=>[o(l,{class:"loginBtn",onClick:t[0]||(t[0]=e=>h())},{default:r((()=>[o(l,{class:"loginIcon appleIcon"}),o(d,null,{default:r((()=>[s("Sign in with Apple")])),_:1})])),_:1}),o(l,{class:"loginBtn",onClick:t[1]||(t[1]=e=>h())},{default:r((()=>[o(l,{class:"loginIcon googleIcon"}),o(d,null,{default:r((()=>[s("Sign in with Google")])),_:1})])),_:1}),o(l,{class:"loginBtn",onClick:t[2]||(t[2]=e=>h())},{default:r((()=>[o(d,null,{default:r((()=>[s("账号登陆")])),_:1})])),_:1})])),_:1}),o(l,{class:"agreeArea"},{default:r((()=>[o(l,{class:c(["checkbox",p.value?"checked":"check"]),onClick:t[3]||(t[3]=e=>p.value=!p.value)},null,8,["class"]),o(d,{style:{color:"white"}},{default:r((()=>[s(" By sign in app,you agree with ourBy sign in app,you agree with our "),o(d,{style:{color:"red","text-decoration":"underline"}},{default:r((()=>[s("Privacy policy")])),_:1}),s(" and "),o(d,{style:{color:"red","text-decoration":"underline"}},{default:r((()=>[s("Terms of service")])),_:1})])),_:1})])),_:1})])),_:1})}}},[["__scopeId","data-v-73466309"]]);export{Rn as default};
